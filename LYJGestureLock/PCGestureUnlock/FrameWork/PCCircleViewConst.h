 ...
 *  解锁背景色
 */
#define CircleViewBackgroundColor UIColorFromRGB(0xececec)
 ...
 *  选中状态下外空心圆颜色
 */
#define CircleStateSelectedOutsideColor UIColorFromRGB(0x7ebcf2)

/**
 *  错误状态下外空心圆颜色
 */
#define CircleStateErrorOutsideColor UIColorFromRGB(0xff9191)

/**
 *  普通状态下内实心圆颜色
 */
#define CircleStateNormalInsideColor UIColorFromRGB(0xc9c9c9)

/**
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor UIColorFromRGB(0x7ebcf2)

/**
 *  错误状态内实心圆颜色
 */
#define CircleStateErrorInsideColor UIColorFromRGB(0xff9191)
 ...
 *  选中状态下三角形颜色
 */
#define CircleStateSelectedTrangleColor UIColorFromRGB(0x7ebcf2)

/**
 *  错误状态三角形颜色
 */
#define CircleStateErrorTrangleColor UIColorFromRGB(0xff9191)
 ...
 *  普通时连线颜色
 */
#define CircleConnectLineNormalColor UIColorFromRGB(0x7ebcf2)

/**
 *  错误时连线颜色
 */
#define CircleConnectLineErrorColor UIColorFromRGB(0xff9191)
 ...
 *  普通状态下文字提示的颜色
 */
#define textColorNormalState UIColorFromRGB(0x333333)

/**
 *  警告状态下文字提示的颜色
 */
#define textColorWarningState UIColorFromRGB(0xfd5353)
